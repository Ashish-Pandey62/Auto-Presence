...
Original file is located at
    https://colab.research.google.com/drive/1XTw35kzx6UbLA5wKWD2ZUng21aizy81S
...
img,prod_prompt = product_photo('cold drink','refreshing', prod_size=.55, table = True,  prod_img = 'models\models_assets\file.png')
